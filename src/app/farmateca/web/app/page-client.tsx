...
export default function AppHomePage() {
  ...
  const searchOptions = [
    ...
    },
    {
      ...
      description: '222 farmacias con mapa y filtros',
      icon: (
        <svg className="w-12 h-12 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      title: 'Por Familia',
      description: 'Busca por familia farmacológica',
      icon: (
        <svg className="w-12 h-12 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 6h16M4 10h16M4 14h10M4 18h6" />
        </svg>
      ),
      href: '/farmateca/web/app/search/family',
      gradient: 'from-violet-500 to-purple-400',
    },
    {
      title: 'Por Laboratorio',
      description: 'Busca por fabricante',
      icon: (
        <svg className="w-12 h-12 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z" />
        </svg>
      ),
      href: '/farmateca/web/app/search/laboratory',
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-8 px-4">
      <div className="max-w-6xl mx-auto">
        ...
        <motion.div
          ...
          className="bg-gradient-to-br from-farmateca-primary-dark via-farmateca-primary to-farmateca-primary-light dark:from-[#004144] dark:via-[#006064] dark:to-[#00838f] rounded-3xl p-8 text-white mb-8 shadow-xl"
        >
        ...
        >
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-farmateca-card hover:shadow-farmateca-card-hover transition-shadow">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 bg-farmateca-primary/10 dark:bg-farmateca-primary/20 rounded-xl flex items-center justify-center">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-farmateca-card hover:shadow-farmateca-card-hover transition-shadow">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 bg-farmateca-compound/10 dark:bg-farmateca-compound/20 rounded-xl flex items-center justify-center">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-farmateca-card hover:shadow-farmateca-card-hover transition-shadow">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 bg-farmateca-favorites/10 dark:bg-farmateca-favorites/20 rounded-xl flex items-center justify-center">
