...
export const metadata: Metadata = {
  title: 'Política de Privacidad | Farmateca',
  description: 'Política de Privacidad de Farmateca',
};

async function getMarkdownContent() {
  const filePath = path.join(process.cwd(), 'public', 'farmateca', 'legal', 'politica_privacidad_V1.md');
