      ...
      >
        <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-10">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-500">Ingresa a tu cuenta de Farmateca</p>
          </div>

          {/* Google Sign In — arriba del formulario */}
          <motion.button
            type="button"
            ...
            className="w-full flex items-center justify-center gap-3 px-4 py-3.5 border-2 border-gray-300 rounded-xl text-gray-700 bg-white hover:bg-gray-50 hover:border-gray-400 disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-sm hover:shadow-md mb-6"
          >
            ...
            <span className="font-semibold">{loading ? 'Iniciando...' : 'Continuar con Google'}</span>
          </motion.button>
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-3 bg-white text-gray-400">O ingresa con email</span>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <Link href="/farmateca/web/forgot-password" className="text-sm text-farmateca-primary hover:text-farmateca-primary-dark font-medium">
          ...
          <div className="mt-8 text-center">
            <p className="text-gray-500">
              ...
              <Link href="/farmateca/web/register" className="text-farmateca-primary hover:text-farmateca-primary-dark font-semibold">
                Regístrate gratis
              </Link>
            </p>
          </div>
