...
export default function ContactPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const subject = encodeURIComponent(`Contacto Farmateca Web - ${formData.nombre}`);
            ...
            >
              ...
              {submitted ? (
                ...
                >
                  ...
                  <h3 className="text-xl font-semibold text-gray-900 mb-2">Mensaje preparado</h3>
                  <p className="text-gray-600 mb-4">
                    Se ha abierto tu cliente de correo. Envia el mensaje para contactarnos.
                  </p>
                  <button
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    className="w-full bg-teal-600 text-white py-4 rounded-xl font-semibold hover:bg-teal-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                  >
              ...
              <div className="bg-white rounded-2xl shadow-md p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="https://wa.me/56940337486" target="_blank" rel="noopener noreferrer" className="text-green-600 hover:underline">
                      +56 9 4033 7486
                    </a>
                    <p className="text-sm text-gray-500 mt-1">Mensaje directo</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-2xl shadow-md p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href="https://www.instagram.com/farmatecachile/" target="_blank" rel="noopener noreferrer" className="text-pink-600 hover:underline">
                      @farmatecachile
                    </a>
                    <p className="text-sm text-gray-500 mt-1">Siguenos para novedades</p>
                  </div>
                </div>
              </div>
            </motion.div>
