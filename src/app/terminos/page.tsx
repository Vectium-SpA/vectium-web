      ...
      <div className="mx-auto max-w-4xl px-6 py-16 lg:px-8">
        <article className="prose prose-lg prose-gray mx-auto">
          ...
          <section className="mb-12">
            ...
            <h3 className="text-xl font-semibold text-site-ink mb-3">
            ...
            <div className="bg-yellow-50 site-dark:bg-yellow-400/10 border-l-4 border-yellow-400 p-6 my-6">
              <p className="text-lg text-site-ink font-semibold mb-2">
                ⚠️ AVISO IMPORTANTE:
              </p>
              <p className="text-lg text-site-ink leading-relaxed">
              ...
              <ul className="list-disc pl-6 text-lg text-site-ink mt-3 space-y-2">
          ...
          <section className="mb-12">
            ...
            <p className="text-lg text-site-ink leading-relaxed">
              ...
              <a href="/privacidad" className="text-site-accent hover:underline font-semibold">
          ...
          <section className="mb-12">
            ...
            <ul className="list-disc pl-6 text-lg text-site-ink space-y-2 mt-4">
          ...
          <section className="mb-12">
            ...
            <div className="bg-site-surface p-6 rounded-lg border border-site-border">
              ...
              <p className="text-lg text-site-ink">Sitio web: https://vectium.cl</p>
              <p className="text-lg text-site-ink">Domicilio: Chile</p>
            </div>
          </section>
