            ...
            >
              {isPremium ? (
                ...
                <div className="p-6 flex flex-col items-center text-center gap-4">
                  ...
                  <div>
                    <h4 className="text-base font-bold text-gray-900 dark:text-white mb-1">Asistente Farmacológico</h4>
                    <p className="text-sm text-gray-500 dark:text-gray-400">
                      El chatbot de consultas farmacológicas estará disponible muy pronto para usuarios Premium.
                    </p>
                  </div>
                  <button
                    onClick={() => setShowModal(false)}
