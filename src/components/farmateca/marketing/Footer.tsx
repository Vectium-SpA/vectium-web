...
export function Footer() {
  ...
  const footerLinks = {
    ...
    contacto: [
      ...
      { href: 'https://wa.me/56940337486', label: 'WhatsApp', external: true },
      { href: 'https://www.instagram.com/farmatecachile/', label: 'Instagram', external: true },
    ],
  };
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-gray-400 mb-6 leading-relaxed">
              Vademecum farmacologico para profesionales de la salud en Chile.
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-gray-500 text-sm">
              &copy; {currentYear} Farmateca. Todos los derechos reservados.
            </p>
